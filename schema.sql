...
VALUES (
    ...
    '$2y$10$u4dz1Un4S7fW5mINvcTNcO7Dw5QG8vtP4DvtgJxyfNVHvQygrnQW2',
    'admin',
    'active',
    NULL,
    NULL
...
VALUES (
    'John Doe',
    'john.doe@cargoconnect.com','USERpass123456',
    'customer', 'active',
    '09171234567', '123 Main St, Manila');

-- Initial fleet vehicles across Philippine port hubs
INSERT INTO fleet (
    fleet_id, vehicle_type,
    weight_capacity_kg, volume_capacity_cubic,
    current_hub_location, operational_status
)
VALUES
    ('VHC-1001', 'Motorcycle',      25,      0.50,   'Manila Port',      'available'),
    ('VHC-1002', 'Pickup Truck',    1000,    8.00,   'Batangas Port',    'available'),
    ('VHC-1003', 'Van',             1200,    12.00,  'Cebu Port',        'available'),
    ('VHC-1004', 'Small Truck',     3000,    25.00,  'Davao Port',       'available'),
    ('VHC-1005', 'Medium Truck',    7000,    45.00,  'Manila Port',      'available'),
    ('VHC-1006', 'Large Truck',     14000,   75.00,  'Cagayan de Oro',   'available'),
    ('VHC-1007', 'Container Truck', 28000,   120.00, 'Subic Bay',        'available'),
    ('VHC-1008', 'Cargo Ship',      500000,  5000.00,'Manila Port',      'available');